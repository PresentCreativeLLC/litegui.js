...
export let escapeHtmlEntities: any = undefined;
...
export function verifyEscapeHtmlEntities()
{
...
export function beautifyCode(code : string, reserved : any, skip_css : boolean)
{
